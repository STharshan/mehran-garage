...
const services = [
  {
    ...
    description: "Regular maintenance schedules and MOT testing to keep your fleet compliant and roadworthy.",
    icon: <IoMdSettings className="h-8 w-8 text-blue-600" />,
  },
  {
    id: 2,
    title: "General Mechanical Repairs",
    description: "Expert repairs for brakes, suspension, engines, and all mechanical components.",
    icon: <AiOutlineTool className="h-8 w-8 text-blue-600" />,
  },
  {
    id: 3,
    title: "Tyre Fitting & Alignment",
    description: "Professional tyre fitting and wheel alignment services for optimal performance and safety.",
    icon: <AiOutlineSafety className="h-8 w-8 text-blue-600" />,
  },
  {
    id: 4,
    title: "Diagnostics & Electrical",
    description: "Advanced diagnostic equipment and electrical repair services for modern vehicle systems.",
    icon: <CheckCircle className="h-8 w-8 text-blue-600" />,
  },
  {
    id: 5,
    title: "Breakdown Recovery",
    description: "24/7 emergency breakdown recovery and on-site repairs to minimize downtime.",
    icon: <Phone className="h-8 w-8 text-blue-600" />,
  },
  {
    id: 6,
    title: "Collection & Delivery",
    description: "Convenient vehicle collection and delivery service with fleet tracking and reminders.",
    ...
    <section className="py-12 px-6 bg-gray-50">
      <div className="container mx-auto text-black text-center">
        ...
        <p className="text-xl max-w-3xl mx-auto font-semibold mb-7">
          Comprehensive fleet services designed to keep your vehicles on the road and your business moving forward.
        </p>
      </div>
