...
export default function VehicleEnd() {
  return (
    <section className="px-4 py-10 bg-black">
      ...
      <div className="max-w-7xl mx-auto bg-blue-600 rounded-xl shadow-md p-6 md:p-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-sm md:text-base text-gray-200">
          <div>
      ...
      <div className="max-w-7xl mx-auto mt-10 p-6 md:p-10 rounded-xl bg-blue-600 text-center">
        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">Service Intervals</h2>
        <p className="text-gray-200 mb-6  mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center text-white gap-8 text-sm md:text-base">
          <div>
