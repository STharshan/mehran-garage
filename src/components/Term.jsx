          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to Mehran's Garage.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          ...
                          <p>Email: <a href="mailto:braaimaster2020@icloud.com" className="text-green-900 hover:underline"></a></p>
