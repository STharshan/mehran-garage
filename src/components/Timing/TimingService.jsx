...
const TimingServices = () => {
  return (
    <section className="bg-gray-50 px-4 py-10">
      ...
      {/* Warning Box */}
      <div className="mt-10 max-w-7xl mx-auto bg-blue-50 border border-blue-200 rounded-md p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-blue-600">
          <ul className="space-y-2">
            {[
              ...
              "blueuced engine performance",
              "Engine won’t start after timing service",
            ].map((item, index) => (
              <li key={index} className="flex items-start">
                <FaExclamationTriangle className="mr-2 mt-1 text-blue-500" /> {item}
              </li>
            ))}
          </ul>
          <ul className="space-y-2">
